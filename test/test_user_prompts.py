...
class TestValidHeadings:
    ...
    def test_returns_true(self):
        temp_file = "data/headings_test.csv"
...
class TestGetCSVFilepath:
    @pytest.mark.it('Returns string')
    @patch("src.user_prompts.input", return_value="candidates.csv")
    def test_returns_str(self, mock_input):
        """using patching to provide mock user input: candidates.csv"""
    ...
    def test_returns_expected_path(self, mock_input):
        ...
        filepath = get_csv_filepath()
        assert filepath == "data/candidates.csv"

    @pytest.mark.it('Adds file extension when not provided')
    @patch("src.user_prompts.input", return_value="candidates")
    def test_adds_file_extension(self, mock_input):
        """using patching to provide mock user input: candidates"""
    ...
    def test_non_existent_file(self, mock_input):
        ...
        mock_input.side_effect = ["Missing", "Testing.xlsx", "candidates.csv"]
        filepath = get_csv_filepath()
        assert filepath == "data/candidates.csv"
    ...
    def test_invalid_headings(self, mock_input):
        ...
        mock_input.side_effect = [temp_file, "candidates.csv"]
        filepath = get_csv_filepath()
        assert filepath == "data/candidates.csv"
